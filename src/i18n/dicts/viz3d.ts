...
export const viz3dZh: LocaleDictionary = {
  ...
  'viz3d.surface.desc': '高度场网格 z=f(x,y) 三维表面渲染，支持项目数据文件与参数函数，自适应视角',
...
export const viz3dEn: LocaleDictionary = {
  ...
  'viz3d.surface.desc': 'Height-field surface plots z=f(x,y) from project files or parameter functions, auto-fit view',
